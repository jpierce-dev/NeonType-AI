...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-dark-bg text-slate-200 flex flex-col items-center px-3 py-2 md:px-6 selection:bg-neon-blue/30 selection:text-white overflow-y-auto">
      <Header
